                  ...
                  <div class="bottom_co_btn_item">
                   ...
                   <?php
                    if(($type_check_in_out == 1 && ($break_check_in_out == '' || $break_check_in_out == '2')) || is_admin()){ ?>
                      <div class="bottom_co_btn_item"> 
                       <?php echo form_open(admin_url('timesheets/break_in_ts'),array('id'=>'timesheets-form-check-in', 'onsubmit'=>'get_data()')); ?>
                       <input type="hidden" name="staff_id" value="<?php echo get_staff_user_id(); ?>">
                       <input type="hidden" name="type_check" value="1">
                       <input type="hidden" name="edit_date" value="">
                       <input type="hidden" name="point_id" value="">
                       <input type="hidden" name="location_user" value="">
                       <button class="btn btn-primary break_in"><?php echo _l('break_in'); ?></button>
                     </div>
                     <?php echo form_close();
                    } ?>
                   ...
                   <?php
                    if(($break_check_in_out == '1') || is_admin()){ ?>
                      <div class="bottom_co_btn_item"> 
                       ...
                       <input type="hidden" name="point_id" value="">
                       <input type="hidden" name="location_user" value="">
                       <button class="btn btn-danger break_out"><?php echo _l('break_out'); ?></button>
                     </div>
                     <?php echo form_close(); } ?>
